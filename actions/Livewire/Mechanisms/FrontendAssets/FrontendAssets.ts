...
* @route '/livewire-977f6a35/livewire.js'
*/
...
returnJavaScriptAsFile.definition = {
    methods: ["get","head"],
    url: '/livewire-977f6a35/livewire.js',
...
* @route '/livewire-977f6a35/livewire.min.js.map'
*/
...
maps.definition = {
    methods: ["get","head"],
    url: '/livewire-977f6a35/livewire.min.js.map',
} satisfies RouteDefinition<["get","head"]>
...
* @route '/livewire-977f6a35/livewire.csp.min.js.map'
*/
...
cspMaps.definition = {
    methods: ["get","head"],
    url: '/livewire-977f6a35/livewire.csp.min.js.map',
} satisfies RouteDefinition<["get","head"]>
