...
## Project Rules
- This project keeps committed, area-grouped rules in ___SINGLE_BACKTICK___.ai/rules___SINGLE_BACKTICK___ (settled decisions, non-obvious traps, standing constraints). Before you enter plan mode or create/edit any file, you MUST first: open @.ai/rules/index.md (it maps file globs to rule files), read every rule file whose globs cover the path(s) in scope, and run ___SINGLE_BACKTICK___grep -rin 'keyword' .ai/rules___SINGLE_BACKTICK___ to catch what a path match alone misses. Do not write code until you have read and are following every matching rule.
<?php if($assist->hasMcpEnabled()): ?>
...
<?php endif; ?>
<?php /**PATH /home/redos/example-app/storage/framework/views/34a53144bd5824fbc4b1fc9c16249813.blade.php ENDPATH**/ ?>