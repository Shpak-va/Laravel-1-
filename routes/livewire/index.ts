...
* @route '/livewire-977f6a35/upload-file'
*/
...
uploadFile.definition = {
    methods: ["post"],
    url: '/livewire-977f6a35/upload-file',
...
* @route '/livewire-977f6a35/preview-file/{filename}'
*/
...
previewFile.definition = {
    methods: ["get","head"],
    url: '/livewire-977f6a35/preview-file/{filename}',
